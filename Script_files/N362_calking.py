from multinest_def_NC_one_preking import PyNM as PyNM
print("Loaded succesfully")
PMN=PyNM("NGC362",35,outbase_add="preking")
import numpy as np
import scipy.stats
...
def prior(cube, ndim, nparams):
	...
	#cube[11] = scipy.stats.norm(0.0027,0.00008).ppf(cube[11]) 
	#cube[12] = scipy.stats.norm(0.1752,0.008).ppf(cube[12])
