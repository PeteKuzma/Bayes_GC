...
#mpirun -n 32 python omega_calking.py
#mpirun -n 32 python omega_calk5.py
#mpirun -n 32 python omega_plumquad5.py
#mpirun -n 32 python omega_plumquad.py


#python omega_plumquad5.py
python omega_plumquad.py
