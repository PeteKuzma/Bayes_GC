...
#PyNM.__init__(self,cluster,radius,prior,inner_radii,sample_size,cr,tr,lh,select=True,pm_sel="norm",live_points=400,existing=False,rmax=4.,Fadd=None,preking=False,outbase_add=None)
